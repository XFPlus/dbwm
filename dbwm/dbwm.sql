...
INSERT INTO `customer` VALUES ('11', null, '130200630', null, null, '大运村');
INSERT INTO `customer` VALUES ('12', null, '100', null, null, '中国');
INSERT INTO `customer` VALUES ('13', null, '13020063091', null, null, '中国大运村');
INSERT INTO `customer` VALUES ('14', null, '13020063092', null, null, '中国北京大运村');
...
INSERT INTO `loging` VALUES ('11', 'xfplus', '142857', '1');
...
CREATE TABLE `worker` (
  ...
  `age` int(11) DEFAULT NULL,
  PRIMARY KEY (`number`),
  UNIQUE KEY `workername` (`workername`),
  KEY `companynum` (`companynum`),
