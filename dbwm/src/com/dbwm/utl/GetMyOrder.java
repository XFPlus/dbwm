...
@WebServlet(name="GetMyOrder",urlPatterns="/servlet/GetMyOrder")
public class GetMyOrder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "select ordernum,loging.number,shopname,money from ordering,loging,shop where loging.number=ordering.number and shopnum=shop.number and zhanghao='"+userid+"'";
			...
			while(rs.next()){
				...
				str=str+"<span class='shopname'>"+rs.getString("shopname")+"</span>";
